...
namespace razorweb.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (info == null)
            {
                ErrorMessage = "Không lấy được thông tin.";
                return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
            }
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if((registerUser!=null)&&(externalEmailUser!=null))
                {
                    ...
                    {
                         ModelState.AddModelError(string.Empty,"Không liên kết được tài khoản, hãy dùng tài khoản khác");
                        return Page();
                    }
                }
                ...
                {
                    ModelState.AddModelError(string.Empty,"không hỗ trợ tạo tài khoản mới với email khác với email từ dịch vụ ngoài");
                }
                ...
                if((externalEmailUser == null)&&(externalEmail == Input.Email))
                {
                    ...
                    var resuiltNewUser = await _userManager.CreateAsync(newUser);
                    if(resuiltNewUser.Succeeded)
                    {
